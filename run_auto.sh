...
log_dir=output_auto_dp2mp2pp2_loadmp2pp2_step2
rm -rf $log_dir
python -m paddle.distributed.launch --log_dir $log_dir --devices "0,1,2,3,4,5,6,7" \
    ./tools/auto.py \
    -c ppfleetx/configs/nlp/gpt/auto/pretrain_gpt_1.3B_dp2mp2pp2.yaml \
    -o Engine.max_steps=2 \
    -o Engine.save_load.output_dir="$log_dir" \
    -o Engine.save_load.ckpt_dir="/gpt3/PaddleFleetX/output_dp2mp2pp2"
